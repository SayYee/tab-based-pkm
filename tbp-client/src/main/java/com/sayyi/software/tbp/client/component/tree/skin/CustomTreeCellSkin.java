 ...
 * @since 9
 */
public class CustomTreeCellSkin<T> extends CellSkinBase<TreeCell<T>> {
    ...
    public CustomTreeCellSkin(TreeCell<T> control) {
        ...
        behavior = new CustomTreeCellBehavior<>(control);
        ...
        if (indent == null) {
            indent = new StyleableDoubleProperty(10.0) {
                @Override public Object getBean() {
                    return CustomTreeCellSkin.this;
                }
    ...
    private static class StyleableProperties {
        ...
        private static final CssMetaData<TreeCell<?>,Number> INDENT =
            ...
            @Override public boolean isSettable(TreeCell<?> n) {
                DoubleProperty p = ((CustomTreeCellSkin<?>) n.getSkin()).indentProperty();
                return p == null || !p.isBound();
            }

            @Override public StyleableProperty<Number> getStyleableProperty(TreeCell<?> n) {
                final CustomTreeCellSkin<?> skin = (CustomTreeCellSkin<?>) n.getSkin();
